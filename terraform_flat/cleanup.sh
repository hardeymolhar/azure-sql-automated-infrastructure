...
echo -e "\033[32mCleanup complete. Next: ./init.sh\033[0m"
...
terraform plan -out=tfplan -var-file=terraform.tfvars --parallelism=3 -var="resource_group_name=$primary_rg"
...
echo -e "\e[33mExecuting vmconfig.sh...\e[0m"
