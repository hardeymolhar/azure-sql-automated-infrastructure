...
# =========================================================
# PREREQUISITES — Load environment + find the resource group
# =========================================================
# WHAT: env.ps1 sets shared variables, notably $RESOURCE_SUFFIX — the random
#       string baked into every resource name in this sandbox.
# WHY:  every resource is named "<thing>-<suffix>", so loading the suffix once
#       lets us discover each resource by name instead of hardcoding it.
./env.ps1
