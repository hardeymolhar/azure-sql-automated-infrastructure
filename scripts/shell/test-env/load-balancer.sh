...
# fall back to the subnet-stg-ind-49 NSG. Echoes the NSG name, or nothing if neither
...
# Target whatever NSG actually governs each node's NIC (NIC- or subnet-stg-ind-49),
