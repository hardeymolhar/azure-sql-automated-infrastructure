...
# fall back to the subnet-res-ind-190 NSG. Echoes the NSG name, or nothing if neither
...
# Target whatever NSG actually governs each node's NIC (NIC- or subnet-res-ind-190),
